#define MICROPY_HW_BOARD_NAME       "ISURLOG_IO"
#define MICROPY_HW_MCU_NAME         "STM32L431CC"
...
// UART config
// USART3 is used for the REPL
#define MICROPY_HW_UART3_TX     (pin_B10)
#define MICROPY_HW_UART3_RX     (pin_B11)

// LPUART1 is used for Modbus
#define MICROPY_HW_LPUART1_TX   (pin_A2)
#define MICROPY_HW_LPUART1_RX   (pin_A3)

// Make the REPL available on USART3
...
// LEDs
#define MICROPY_HW_LED1             (pin_B0) //TX LED
#define MICROPY_HW_LED2             (pin_B15) //RX LED
